        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            >
              ...
              <button
                type="submit"
                className="rounded-md bg-gold px-4 py-2 text-sm font-medium text-forest-dark transition-colors hover:bg-gold-light focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-2 focus-visible:ring-offset-charcoal"
              >
                Subscribe
              </button>
            </form>
